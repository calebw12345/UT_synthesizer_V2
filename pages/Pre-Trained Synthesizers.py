...
st.write("")
st.write("")
new_title8 = '<p style="font-family:sans-serif; color:rgb(255, 255, 255); font-size: 20px;"><b>Enter The Number of A-scans You Want to Synthesize (Has to Be Greater Than 1):</b></p>'
