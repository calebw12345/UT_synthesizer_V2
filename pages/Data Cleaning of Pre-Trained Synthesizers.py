...
if option1 == "Variation Autoencoder":
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\VAE\pre_clean_metrics\dist'+str(to_p)+'.png')
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\VAE\pre_clean_metrics\mean'+str(to_p)+'.png')
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\VAE\pre_clean_metrics\std'+str(to_p)+'.png')
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\VAE\post_clean_metrics\dist'+str(to_p)+'.png')
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\VAE\post_clean_metrics\mean'+str(to_p)+'.png')
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\VAE\post_clean_metrics\std'+str(to_p)+'.png')
if option1 == "Generative Adversarial Network":
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\GAN\pre_clean_metrics\dist'+str(to_p)+'.png')
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\GAN\pre_clean_metrics\mean'+str(to_p)+'.png')
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\GAN\pre_clean_metrics\std'+str(to_p)+'.png')
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\GAN\post_clean_metrics\dist'+str(to_p)+'.png')
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\GAN\post_clean_metrics\mean'+str(to_p)+'.png')
    st.image(r'C:\Users\caleb\Documents\5122\week8lab\brinda\GAN\post_clean_metrics\std'+str(to_p)+'.png')
if option1 == "-":
    print()